...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Id категории. Example: <code>11</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    ...
    --form "title=nulla"\
    --form "description=Mollitia officiis id id eos adipisci aut est."\
    --form "result=voluptas"\
    --form "Purpose=explicabo"\
    --form "price=19"\
    --form "sizes[][unit]=saepe"\
    --form "sizes[][value]=eligendi"\
    --form "avatar=@/tmp/phpc99BNp" \
    --form "images[]=@/tmp/php9V5x1A" </code></pre></div>
...
body.append('title', 'nulla');
body.append('description', 'Mollitia officiis id id eos adipisci aut est.');
body.append('result', 'voluptas');
body.append('Purpose', 'explicabo');
body.append('price', '19');
body.append('sizes[][unit]', 'saepe');
body.append('sizes[][value]', 'eligendi');
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="Mollitia officiis id id eos adipisci aut est."
               data-component="body">
    <br>
<p>Example: <code>Mollitia officiis id id eos adipisci aut est.</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Example: <code>/tmp/phpc99BNp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
        <details>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>5(#Q&gt;&lt;f&gt;&amp;yWI{/_</code></p>
        </div>
        </form>
